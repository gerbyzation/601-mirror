...
module.exports = function(app) {
  ...
  db.serialize(() => {
    ...
    db.run('CREATE TABLE feeds (id VARCHAR(100) PRIMARY KEY NOT NULL, status TEXT NOT NULL, node TEXT, url VARCHAR(255) NOT NULL UNIQUE, color INTEGER, color_verified DATETIME);', (err, res) => { if (err) logger.error('create feeds table', err) });
